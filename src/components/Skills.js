      ...
      <div className="relative max-w-[1920px] mx-auto px-6 md:px-12 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[47.6px] mb-[95.2px]">
          ...
          <div className="lg:col-span-8">
            <div className="bg-[#F2F2F2] border border-[rgba(35,35,35,0.1)] p-8 transition-all duration-1500 hover:shadow-[0_8px_32px_rgba(35,35,35,0.1)] relative overflow-hidden">
