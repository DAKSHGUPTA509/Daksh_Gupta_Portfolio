...
const Projects = () => {
  ...
  return (
    <section id="projects" className="relative py-[20.2px] bg-gradient-to-r from-gray-900 to-black flex items-center overflow-hidden">
      ...
      <div className="relative max-w-[1920px] mx-auto px-6 md:px-12 z-10">
        ...
        <div className="flex flex-col items-center mb-[95.2px]">
          ...
          <div className="flex items-center mb-8 space-x-4">
            <Filter size={25} className="text-[#38FF62] animate-pulse" />
            <h3 
              className="font-mono text-[18px] font-normal text-white uppercase tracking-[0.05em]"
              style={{ fontFamily: 'ui-monospace, monospace' }}
            >
              PROJECT CATEGORIES
            </h3>
            <Zap size={24} className="text-[#FFA726] animate-bounce" />
          </div>
            ...
            {categories.map((category, index) => {
              ...
              return (
                <button
                  ...
                  className={`
                    group relative px-6 py-3 font-mono text-[12px] font-normal uppercase tracking-[0.04em] 
                  ...
                  style={{ 
                    ...
                    borderColor: isSelected ? categoryColor : '#38FF62',
                    backgroundColor: isSelected ? `${categoryColor}10` : 'black',
                    color: isSelected ? categoryColor : '#ffffffff',
                ...
                >
                  ...
                  <div className="relative flex items-center space-x-2 z-10">
                    ...
                    <div 
                      className={`
                        px-2 py-0.5 font-mono text-[10px] font-normal uppercase tracking-[0.05em] border transition-all duration-300
                        ${isSelected 
                          ? 'bg-black border-current' 
                          : 'bg-[rgba(253, 251, 251, 1)] border-[rgba(255, 254, 254, 1)] group-hover:border-current'
                        }
                      `}
                      style={{ 
                        fontFamily: 'ui-monospace, monospace',
                        color: isSelected ? categoryColor : 'rgba(248, 247, 247, 1)'
                      }}
                    >
          ...
          <div className="mt-8 flex items-center space-x-8">
            <div className="text-center">
              ...
              <div 
                className="font-mono text-[12px] font-normal text-white uppercase tracking-[0.05em]"
                style={{ fontFamily: 'ui-monospace, monospace' }}
              >
                SHOWING PROJECTS
              </div>
            ...
            <div className="w-px h-8 bg-[rgba(248, 247, 247, 0.97)]" />
        ...
        <div className="mt-[95.2px]">
          <div className="text-center mb-12">
            <h3 
              className="font-mono text-[18px] font-normal text-white uppercase tracking-[0.05em] flex items-center justify-center"
              style={{ fontFamily: 'ui-monospace, monospace' }}
            >
              <TrendingUp size={24} className="mr-2 text-[#38FF62] animate-pulse" />
              PROJECT STATISTICS
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[47.6px] max-w-4xl mx-auto">
            {[
              ...
              return (
                <div 
                  key={index} 
                  className="group relative bg-black border border-[#38FF62] p-8 text-center transition-all duration-500 hover:translate-y-[-4px] hover:shadow-[0_12px_32px_rgba(35,35,35,0.15)] overflow-hidden"
                >
                  
                  {/* Animated background */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${stat.gradient} opacity-10 group-hover:opacity-5 transition-opacity-10 duration-500`} />
                  
                  {/* Icon */}
                  <div className="relative z-10 flex justify-center mb-6">
                    <div 
                      className="p-4 transition-all border-[#38FF62] duration-500 group-hover:scale-110 group-hover:rotate-12"
                  ...
                  {/* Value */}
                  <div 
                    className="relative z-10 font-normal text-white leading-none mb-4 group-hover:scale-110 transition-transform duration-300"
                    style={{ 
                      fontFamily: 'ui-sans-serif, system-ui, sans-serif',
                      fontSize: 'clamp(40-px, 8vw, 48px)'
                    }}
                  >
                    {stat.value}
                  </div>
                  ...
                  {/* Label */}
                  <div 
                    className="relative z-10 font-mono text-[8px] md:text-[12px] font-normal text-white uppercase tracking-[0.05em] group-hover:text-[#38FF62] transition-colors duration-300"
                    style={{ fontFamily: 'ui-monospace, monospace' }}
                  >
                    {stat.label}
                  </div>
