...
const Projects = () => {
  ...
  return (
    <section id="projects" className="relative py-[20.2px] bg-[#F2F2F2] overflow-hidden">
      ...
      <div className="relative max-w-[1920px] mx-auto px-6 md:px-12 z-10">
        ...
        <div className="text-center mb-[95.2px]">
          ...
          >
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 sm:w-48 h-1 bg-gradient-to-r from-[#38FF62] via-[#4ECDC4] to-[#FFA726] animate-pulse" />
          </h2>
