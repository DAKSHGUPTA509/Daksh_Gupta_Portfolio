...
const ProjectCard3D = ({ project, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`
          relative bg-gradient-to-r from-gray-800 to-gray-950 border overflow-hidden
          transition-all duration-500 ease-out cursor-pointer
          ${isHovered 
            ? 'transform translate-y-[-8px] scale-[1.02] shadow-[0_20px_40px_rgba(35,35,35,0.15)] border-[#38FF62]' 
            : 'transform translate-y-0 scale-100 shadow-[0_4px_20px_rgba(35,35,35,0.1)] border-gray-700'
          }
        `}
        style={{
          transformStyle: 'preserve-3d',
      ...
      >
        ...
        <div className="relative p-6 border-b border-[rgba(251, 249, 249, 0.1)] overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              ...
              <span 
                className="font-mono text-[15px] font-bold text-gray-300 uppercase tracking-[0.1em] bg-[rgba(56,255,98,0.1)] px-2 py-1 group-hover:bg-[rgba(56,255,98,0.2)] transition-colors duration-300"
            ...
            <div className="flex space-x-2">
              ...
              <button className="p-2 text-gray-300 hover:bg-[#38FF62] hover:text-white transition-all duration-300 hover:scale-110 hover:rotate-12">
                <Github size={24} />
              </button>
              </a>
          ...
          {/* Animated title */}
          <h3 
            className="text-white mb-3 group-hover:text-[#38FF62] font-bold transition-colors duration-300"
            style={{ 
          ...
          <p 
            className="font-xl text-gray-400 leading-[2] mb-4 group-hover:text-gray-200 transition-colors duration-300"
            style={{ 
              fontFamily: 'ui-sans-serif, system-ui, sans-serif',
          ...
          {project.metrics && (
            <div className="flex items-center mb-4 group-hover:scale-105 transition-transform duration-300">
              ...
              <span 
                className="font-mono text-[12px] font-normal text-gray-400 uppercase tracking-[0.05em]"
                style={{ fontFamily: 'ui-monospace, monospace' }}
              >
                {project.metrics}
              </span>
        ...
        <div className="p-6">
          <div className="mb-6">
            <h4 
              className="font-mono text-[12px] font-normal text-gray-300 uppercase tracking-[0.05em] mb-3 flex items-center"
              style={{ fontFamily: 'ui-monospace, monospace' }}
            >
            ...
            <div className="flex flex-wrap gap-2">
              {project.technologies.map((tech, techIndex) => (
                <span
                  key={techIndex}
                  className="px-3 py-1 bg-gray-800 font-mono text-[10px] font-normal text-gray-300 uppercase tracking-[0.05em] border border-gray-700 hover:bg-[#38FF62] hover:text-white hover:scale-110 transition-all duration-300 cursor-pointer"
                  style={{ 
          ...
          {/* Enhanced CTA button */}
          <button className="w-full relative overflow-hidden bg-transparent border border-gray-700 px-6 py-3 font-mono text-[12px] font-normal text-gray-300 uppercase cursor-pointer transition-all duration-300 min-h-[44px] flex items-center justify-center tracking-[0.05em] group-hover:border-[#38FF62] group-hover:text-[#38FF62] group-hover:scale-[1.02] group-hover:shadow-[0_4px_20px_rgba(56,255,98,0.2)]">
