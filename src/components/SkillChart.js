...
const SkillChart = ({ skills, title, color = "#38FF62" }) => {
  ...
  const skillLevels = {
    ...
    // Default for others
          "Teamwork" : 85 ,
           "Communication" : 75 ,
            "Leadership" : 86 , "Analytical Thinking" : 92, 
      "Adaptability" : 89, "Growth Mindset" : 78, "Creative Content Creation": 80,
    default: 50
  };
        ...
        return (
          <div key={skill} className="group">
            <div className="flex justify-between items-center mb-2">
              <span 
                className="font-normal text-white group-hover:text-[#38FF62] transition-colors duration-300"
                style={{ 
              ...
              <span 
                className="font-mono text-[12px] font-normal text-white group-hover:text-[#38FF62] transition-colors duration-300"
            ...
            <div className="relative h-2 bg-white overflow-hidden">
              <div
