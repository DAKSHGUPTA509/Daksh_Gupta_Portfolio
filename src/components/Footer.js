      ...
      <div className="max-w-[1920px] mx-auto px-6 md:px-12">
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] py-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Heart size={15} className="text-[#38FF62] fill-current" />
            <span 
              className="font-normal text-[rgba(255,255,255,0.7)]"
              style={{ 
                fontFamily: 'ui-sans-serif, system-ui, sans-serif',
        ...
        <div 
          ...
          style={{
            backgroundImage: 'linear-gradient(to right, rgba(249, 246, 246, 1) 3px, transparent 1px), linear-gradient(to bottom, rgba(250, 246, 246, 1) 5px, transparent 1px)',
