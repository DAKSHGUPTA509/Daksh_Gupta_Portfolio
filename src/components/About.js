...
const About = () => {
  ...
  return (
    <section id="about" className="py-auto bg-[#F2F2F2]">
      <div className="max-w-[1920px] mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-[95.2px] relative">
          ...
          <h2 
            className="font-normal text-[#232323] uppercase leading-none relative animate-fadeInUp z-10"
            style={{ 
          ...
          >
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-1 bg-gradient-to-r from-[#38FF62] via-transparent to-[#38FF62] opacity-50 animate-pulse"></div>
          </h2>
          
          <div 
            className="font-mono text-[10px] md:text-[18px] font-normal text-[#232323] uppercase tracking-[0.05em] mt-6 animate-fadeInUp z-10"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-[auto] lg:gap-[60px]">
          ...
          <div className="space-y-8 md:space-y-12 lg:space-y-[47.6px]">
            <div className="bg-white border border-[rgba(35,35,35,0.1)] p-4 sm:p-6 rounded-lg transition-all duration-200 hover:translate-y-[-2px] hover:shadow-[0_4px_20px_rgba(35,35,35,0.1)]">
          ...
          <div className="mt-8 md:mt-12 lg:mt-[47.6px]">
            <div className="bg-white border border-[rgba(35,35,35,0.1)] p-4 sm:p-6 rounded-lg transition-all duration-200 hover:translate-y-[-2px] hover:shadow-[0_4px_20px_rgba(35,35,35,0.1)]">
              <h3 
                className="font-mono text-[14px] font-normal text-[#232323] uppercase mb-6 tracking-[0.05em] flex items-center"
                style={{ fontFamily: 'ui-monospace, monospace' }}
              >
              ...
              <div className="space-y-6">
                {certifications.map((cert, index) => (
                  <div key={index} className="relative pb-4 last:pb-0">
                    <h4 
                      className="font-normal text-[#232323] mb-2 text-left"
                      style={{ 
                        fontFamily: 'ui-sans-serif, system-ui, sans-serif',
