...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 bottom-0 bg-black opacity-100 pointer-events-none z-[-1]" 
           style={{
      ...
      <header 
        className={`
          ...
          ${scrolled 
            ? 'bg-[rgba(17,24,39,0.95)] backdrop-blur-lg border-b border-[rgba(56,255,98,0.3)] shadow-[0_4px_32px_rgba(35,35,35,0.1)]' 
            : 'bg-black border-b border-[rgba(251, 252, 252, 1)] shadow-[0_4px_32px_rgba(35,35,35,0.1)]'
          }
        `}
      >
          ...
          <div className="flex items-center justify-between h-[95.2px]">
                ...
                `}>
                  <Zap 
                    ...
                    className={`
                      ...
                      ${scrolled ? 'text-[#38FF62] animate-pulse' : 'text-gray-300'}
                    `} 
                  />
                </div>
                ...
                <div 
                  className={`
                    ...
                    ${scrolled 
                      ...
                      : 'text-white group-hover:text-[#38FF62]'
                    }
                  `}
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {navItems.map(({ label, id }, index) => (
                <button
                  key={id}
                  className={`
                    group relative font-mono text-[15px] font-normal uppercase tracking-[0.05em] 
                    px-4 py-2 transition-all duration-300 overflow-hidden
                    ${scrolled 
                      ? 'text-white hover:text-[#38FF62]' 
                      : 'text-gray-300 hover:text-[#38FF62]'
                    }
                  `}
                  style={{ 
            ...
            <button
              className={`
                ...
                ${scrolled ? 'text-[#38FF62]' : 'text-gray-300 hover:text-[#38FF62]'}
              `}
              onClick={() => setIsMenuOpen(!isMenuOpen)}
            >
              <div className="relative">
                {isMenuOpen ? (
                  <X size={30} className="animate-spin" />
                ) : (
                  <Menu size={30} />
                )}
        ...
        `}>
          <div className="bg-black onscroll:bg-[rgba(17,24,39,0.98)] backdrop-blur-lg hover:bg-[rgba(17,24,39,0.98)] backdrop-blur-lg">
            <nav className="flex flex-col py-6 px-6 space-y-2">
              {navItems.map(({ label, id }, index) => (
                <button
                  ...
                  className={`
                    ...
                    text-gray-300 hover:text-[#38FF62] animate-fadeInUp
                  `}
                  style={{ 
                    fontFamily: 'ui-monospace, monospace',
                    animationDelay: `${index * 0.1}s`
              ...
              <div className="pt-4 mt-4 border-t border-[rgba(35,35,35,0.1)]">
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span 
                    className="font-mono text-[13px] font-normal text-[rgba(255,255,255,0.7)] uppercase tracking-[0.05em]"
                    style={{ fontFamily: 'ui-monospace, monospace' }}
                  >
